...
function Login() {
  ...
  const sendMail = (event) =>{
    ...
    if (regExp.test(email) === false) {
      ...
      axios.post("/api/v1/user/email-confirm.do", email)
      .then(function(response){
        if (response.status == 200) {
          alert("전송 완료!");
                      ...
                      <div className="login-form-container">
                        <div className="login-register-form">
                          <form onSubmit={onRegisthandler}>
                            <label>이메일</label>
                            <button class="btn" style={{ float: "right" }} onClick={sendMail}>
                              인증번호 받기
                            </button>
                            <input
                              name="user-email"
                            ...
                            />
                            <label>인증번호</label>
                            <button class="btn" style={{ float: "right" }} onClick={sendMailMatch}>
                              인증
                            </button>
                            <input
                            ...
                            <br />
                            <label>MBTI</label>
                            <select name="mbti" className="form-select" onChange={onMbtiHandler}>
