            ...
            <div className="col-lg-12 community-detail-box">
              <div className="community-detail">
                ...
                <div className="community-detail-subtextbox">
                  ...
                  <button className="community-button-remove" onClick={clickRemove}>삭제</button>
                  <button className="community-button-edit" onClick={clickEdit}>수정</button>
                </div>
              </div>
